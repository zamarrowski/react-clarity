...
(0, _react3.storiesOf)('Table', module).addDecorator(_addonKnobs.withKnobs).add('simple', (0, _storybookReadme.withReadme)(_table2.default, function () {
  return _react2.default.createElement(_DataTable2.default, { data: (0, _addonKnobs.object)('Data', data) });
